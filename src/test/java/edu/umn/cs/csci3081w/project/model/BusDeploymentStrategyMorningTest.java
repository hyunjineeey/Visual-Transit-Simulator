...
public class BusDeploymentStrategyMorningTest {
  ...
  public void testGetNextBus() {
    ...
    BusDeploymentStrategyMorning busDeploymentStrategyMorning = new BusDeploymentStrategyMorning();
    Bus testBus = busDeploymentStrategyMorning.getNextBus("0", testOutRoute, testInRoute, 1);
  }
   ...
   */
  @Test
  public void testGetNextBusBusTypeIsNotZero() {
    Stop stop1 = new Stop(0, 44.972392, -93.243774);
    Stop stop2 = new Stop(1, 44.973580, -93.235071);
    Stop stop3 = new Stop(2, 44.975392, -93.226632);
    List<Stop> stopsOut = new ArrayList<Stop>();
    ...
    Route testInRoute = TestUtils.createRouteGivenData(stopsIn, distancesIn, probabilitiesIn);
    BusDeploymentStrategyMorning busDeploymentStrategyMorning = new BusDeploymentStrategyMorning();
    busDeploymentStrategyMorning.setTesting(true);
    Bus testBus = busDeploymentStrategyMorning.getNextBus("0", testOutRoute, testInRoute, 1);
  }
}
